...
public class MediaController extends FrameLayout {
	...
	// 改为默认10秒消失
	private static final int sDefaultTimeout = 10 * 1000;
	...
	public void hide() {
		...
		if (mShowing) {
			try {
				...
				Logger.log("MediaController already removed");
			}
			mShowing = false;
	...
	public long setProgress() {
		...
		long duration = Constants.totalLength * 1000;
		if (mProgress != null) {
			if (duration > 0) {
