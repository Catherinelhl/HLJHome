...
public class AudioPlaylistAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (cover == null) {
            ...
            cover = cache.getBitmapFromMemCache(R.drawable.hljicon);
            if (cover == null) {
                cover = BitmapFactory.decodeResource(v.getResources(), R.drawable.hljicon);
                cache.addBitmapToMemCache(R.drawable.hljicon, cover);
            }
        }
