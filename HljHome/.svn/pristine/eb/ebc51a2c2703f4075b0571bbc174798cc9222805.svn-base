...
public class SidebarAdapter extends BaseAdapter {
	...
	static {
		SidebarEntry entries2[] = {
				new SidebarEntry("video", R.string.video,
						R.drawable.header_icon_video),
				new SidebarEntry("audio", R.string.audio,
						R.drawable.header_icon_audio),
				new SidebarEntry("directories", R.string.directories,
						R.drawable.ic_folder),
				new SidebarEntry("history", R.string.history,
						android.R.drawable.ic_menu_recent_history),
		// new SidebarEntry( "bookmarks", R.string.bookmarks,
	...
	public Fragment fetchFragment(String id) {
		...
		} else if (id.equals("videoinfo")) {
			f = new VideoInfoFragment();
		} else { /* TODO */
