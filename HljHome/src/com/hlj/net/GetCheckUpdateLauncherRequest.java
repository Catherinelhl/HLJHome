...
/**
 * Created with IntelliJ IDEA. User: ${shime} Date: 13-11-28 Time: 下午3:16 To
 * change this template use File | Settings | File Templates.
 */
public class GetCheckUpdateLauncherRequest extends BaseRequest implements
	...
	public GetCheckUpdateLauncherRequest(Context context) {
	...
	public String getInfo() {
		API = HomeConstants.FunctionTagTable.GETCHECKUPDATELAUNCHER.getApi();
		VER = HomeConstants.FunctionTagTable.GETCHECKUPDATELAUNCHER.getVer();
		MODE = HomeConstants.FunctionTagTable.GETCHECKUPDATELAUNCHER.getMode();
	...
	public HomeConstants.FunctionTagTable getNetTag() {
		return HomeConstants.FunctionTagTable.GETCHECKUPDATELAUNCHER; // To
																		// change
																		// body
																		// of
																		// implemented
