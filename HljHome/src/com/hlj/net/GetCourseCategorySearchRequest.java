 ...
 * 
 */
public class GetCourseCategorySearchRequest extends BaseRequest implements
	...
	public GetCourseCategorySearchRequest(Context context) {
	...
	public String getInfo() {
		API = FunctionTagTable.GETCOURSECATEGORYSEARCH.getApi();
		VER = FunctionTagTable.GETCOURSECATEGORYSEARCH.getVer();
		MODE = FunctionTagTable.GETCOURSECATEGORYSEARCH.getMode();
	...
	public FunctionTagTable getNetTag() {
		return FunctionTagTable.GETCOURSECATEGORYSEARCH;
	}
}
