...
public class StringUtils {
	 ...
	 * @return
	 */
	public static int sourceStringToResourceID(String sourceStr) {
		if ("CNTV".equals(sourceStr)) {
			return R.drawable.source_cntv_selector;
		} else if ("huashu".equals(sourceStr)) {
			return R.drawable.source_huashu_selector;
		}
	 ...
	 * @return
	 */
	public static int sourceStrToResourceID(String sourceStr) {
		if ("CNTV".equals(sourceStr)) {
			return R.drawable.source_cntv_focus;
		} else if ("huashu".equals(sourceStr)) {
			return R.drawable.source_dianlv_huashu_focus;
		}
