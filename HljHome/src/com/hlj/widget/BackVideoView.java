 ...
 */
public class BackVideoView extends SurfaceView implements MediaPlayerControl {
	...
	public BackVideoView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initVideoView();
	}

	public BackVideoView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setVideoURI(Uri[] uris, int[] durations) {
		mUris = uris;
