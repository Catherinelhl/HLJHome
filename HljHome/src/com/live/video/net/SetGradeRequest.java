 ...
 * 
 */
public class SetGradeRequest extends BaseRequest implements
	...
	public SetGradeRequest(Context context) {
		androidId = DeviceCheck.getAndroidId(context);
	}

	@Override
	public String getInfo() {
		API = FunctionTagTable.SETGRADEEPG.getApi();
		VER = FunctionTagTable.SETGRADEEPG.getVer();
		MODE = FunctionTagTable.SETGRADEEPG.getMode();
	...
	public FunctionTagTable getNetTag() {
		return FunctionTagTable.SETGRADEEPG;
	}
