...
public class MainActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//btn_play = (Button) v_main.findViewById(R.id.btn_play);

//		btn_play.setOnClickListener(new OnClickListener() {
//
//			@Override
//			public void onClick(View v) {
//				vlcplayVideo("http://v6.tongzhuo100.com/files/primary/one/1D10D4N4GD.mp4");
//			}
//		});
		...
		ImageView home = (ImageView) findViewById(Util.isHoneycombOrLater() ? android.R.id.home
				: R.id.abs__home);
		if (home != null)
	...
	private void changeMenuOffset() {
		...
		// 设置没有menu
		mMenu.setBehindOffset(display.getWidth());
	}
	...
	protected void onResumeFragments() {
		 ...
		 * remove() the currently displayed fragment and replace it with a blank
		 * screen.
		 */
		if (found) {
			FragmentTransaction ft = getSupportFragmentManager()
					.beginTransaction();
			mCurrentFragment="videoinfo";
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.ml_menu_sortby_length:
			...
			if (current instanceof ISortable)
				((ISortable) current)
						.sortBy(item.getItemId() == R.id.ml_menu_sortby_name ? VideoListAdapter.SORT_BY_TITLE
	...
	// http://v6.tongzhuo100.com/files/primary/one/1D10D4N4GD.mp4

	private void onOpenMRL() {
		AlertDialog.Builder b = new AlertDialog.Builder(this);
		final EditText input = new EditText(this);
		input.setText("http://v6.tongzhuo100.com/files/primary/one/1D10D4N4GD.mp4");
		...
		b.setPositiveButton(R.string.open,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int button) {
						vlcplayVideo(input.getText().toString());
					}
				});
	...
	public static void vlcplayVideo(final String address) {
		/* Start this in a new thread as to not block the UI thread */
		VLCCallbackTask task = new VLCCallbackTask(instance) {
			@Override
			public void run() {
